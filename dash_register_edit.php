  ...
  <body>
    <div class="container">
      ...
      <br>
    	<div class="row">
        <div class="col-lg-12">
          <form action="dash_register_update.php?ID=<?php echo $id; ?>" method="post">
            ...
            <div class="form-group col-lg-12">
              <h5>Email:</h5>
              <input type="email" class="form-control" value="<?php echo $row["email"]; ?>" name="new_email" required><br>
            </div>
            <div class="form-group col-lg-12">
              <h5>Password:</h5>
            ...
            <div class="form-group col-lg-12">
              <h5>User Type:</h5>
              <input type="text" class="form-control" value="<?php echo $row["user_type"]; ?>" name="user_type" required><br>
            </div>
