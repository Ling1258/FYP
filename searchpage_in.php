...
if (isset($_POST['submit'])){
  ...
  if ($start >= $end) {
    ...
    header("Location: index.php?msg=".urlencode($msg)); // Redirect with message
            ...
            <div class="row">
              ...
              <div class="col-lg-6">
                ...
                <div class="row">
                  ...
                  <div class="col-lg-12">
                    <a href="payment_in.php?pay=<?php echo $row["id"]; ?>" class="btn btn-success btn-block" ><b>MYR <?php echo $row["vehicle_rent_price"]; ?></b></a>
                  </div>
                </div>
              </div>
            </div>
