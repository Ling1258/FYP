      ...
      <div class="container">
        <div class="row">
          <div class="col-lg-12 glass">
            <div class="BT">
              <h2><span style="color:#6E4BE7;">Pro</span>file Setting</h2>
            </div>
          </div>
        </div>
      </div>
    ...
    <section id="setting">
      <div class="container">
        <div class="row r-space">
          <div class="col-lg-4 col-md-4 c-space">
            <div class="profile_link vl hr">
              <li class="p"><a href="c_ic.php" class="p_link" target="frame_link"><h5>Update IC</h5></a></li>
              <li class="p"><a href="c_name.php" class="p_link" target="frame_link"><h5>Update Name</h5></a></li>
              <li class="p"><a href="c_email.php" class="p_link" target="frame_link"><h5>Update Email</h5></a></li>
              <li class="p"><a href="c_pass.php" class="p_link" target="frame_link"><h5>Update Password</h5></a></li>
            </div>
          </div>
          <div class="col-lg-8 col-md-8 ce-space">
