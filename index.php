          ...
          <div class="container">
            <div class="row">
              <div class="col-lg-12 glass">
                ...
                <form class="" action="searchpage_in.php" method="post">
                  <div class="row">
      ...
      <div class="container">
        <div class="tt-center">
          ...
          <div class="row">
            ...
            <div class="col-lg-6 t-space">
              <h2>Car Rental <span style="color:#6E4BE7;">Partner</span></h2>
          ...
          <div class="row">
            ...
            <div class="col-lg-12 btn-space">
              <a href="ownerpage_in.php" class="btn btn-outline-dark btn-lg">Contact Us Now!</a>
            </div>
          </div>
        </div>
      </div>
