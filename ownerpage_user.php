...
if (isset($_SESSION['store'])){
  ...
  $query = ("SELECT * FROM partnership WHERE p_email = '$email'");
  $result = mysqli_query($con,$query);

  if (mysqli_num_rows($result) == 0) {
      // Redirect to another page
      header("Location: part_blink.php");
        ...
        <div class="row">
          <div class="col-lg-12 glass">
            <div class="BT">
              ...
              <p style="font-size:25px;">Vehicle Plate No: <?php echo $row["p_v_plate_no"];?></p>
            </div>
          </div>
        </div>
      </div>
    ...
    <section id="setting">
      <div class="container">
        <div class="row r-space">
          <div class="col-lg-3 col-md-3 c-space">
            <div class="profile_link vl hr">
              <li class="p"><a href="part_record.php" class="p_link" target="frame_link"><h5>Vehicle Rented Record</h5></a></li>
              <li class="p"><a href="part_earning.php" class="p_link" target="frame_link"><h5>Vehicle Earning</h5></a></li>
              <li class="p"><a href="part_feedback.php" class="p_link" target="frame_link"><h5>Vehicle Feedback</h5></a></li>
            </div>
          </div>
          <div class="col-lg-9 col-md-9 ce-space">
            <iframe src="c_blank.html" name="frame_link" scrolling="no" frameborder="0"></iframe>
          </div>
        </div>
      </div>
    </section>
