      ...
      <div class="card">
        <div class="row">
          <div class="col">
            <h2>Bank Transfer</h2>
            <hr>
            <h5>Please confirm the price and submit the verification code.</h5>
          </div>
        </div>
        <div class="row">
          <div class="col">
            <form class="" action="pay_success_inv_in.php" method="post">
              <div class="row">
                <div class="col">
                  <br>
                  <?php
                    echo "<h6>Current time: " . date("H:i:s") . "</h6>";
                    echo "<h6>Current date: " . date("Y-m-d") . "</h6>";
                  ?>
                  <h6>Total price: RM<?php echo $total_cost; ?></h6>
                </div>
              </div>
              <div class="row">
                <div class="col">
              ...
              <div class="row">
                <div class="col">
                  <br>
                  <button type="submit" name="submit" class="btn btn-success" style="margin:auto;display:block;padding-left:10%;padding-right:10%;">Submit</button>
                </div>
              </div>
            </form>
          </div>
